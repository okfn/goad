...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issuer.email'
        db.alter_column(u'okbadger_issuer', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))

    def backwards(self, orm):

        # Changing field 'Issuer.email'
        db.alter_column(u'okbadger_issuer', 'email', self.gf('django.db.models.fields.CharField')(max_length=255))
